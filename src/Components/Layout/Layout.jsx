...
function Layout() {
    const[isChecked, setIsChecked] =useState(false)
     isChecked ?(document.documentElement.dataset.theme="emerald"):(document.documentElement.dataset.theme="dark")
  return (
    <div className=''>
            <div className="navbar bg-base-100">
                ...
                <div className="navbar-end">
                    <label className="swap swap-rotate">
                        <input type="checkbox"  checked={isChecked} onChange={(a)=>setIsChecked(a.target.checked)}/>
                        <svg className="swap-on fill-current w-8 h-8 pt-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
